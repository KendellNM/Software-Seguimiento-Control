...
public class EmpresaDaoImpl implements EmpresaDao {
    ...
    @Override
    public List<Empresa> readAllByEstado(String estado) {
        return empresaRepository.findAllByEstado(estado);
    }
    ...
    public List<Empresa> searchByNombreAndEstado(String nombre, String estado) {
        return empresaRepository.findByRazonSocialContainingIgnoreCaseAndEstado(nombre, estado);
    }
}